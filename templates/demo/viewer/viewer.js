 ...
 */
    .controller('ViewerController', function($http, $scope, $timeout, $window, BREAKPOINTS, DEFAULT_MODULE,
        ...
        viewer.languages = ['readme', 'template', 'html', 'demo html', 'less', 'scss', 'css', 'js'];
        viewer.modules = {};
        ...
        function getModuleInfo() {
            ...
            if (module.info) {
                ...
                var readmeUrl = getModulePath() + '/readme';
                $http.get(readmeUrl)
                    .then(function setReadme(response) {
                        module.info.readme = response.data;
                        setDefaultLang();
                    });
            }
        }
